        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonName = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbl_Persons", x => x.PersonID);
                    table.ForeignKey(
                        name: "FK_tbl_Persons_tbl_Countries_CountryID",
